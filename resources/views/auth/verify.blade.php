                ...
                <div class="card-body">
                    @if (session('resent'))
                        <div class="alert alert-success" role="alert">
                            Reenviamos um e-mail para você com o link de verificação.
                        </div>
                    @endif
                    ...
                    <br>
                    Caso você não tenha recebido p e-mail de verificação, clique o link a seguir para receber um novo e-mail.
